...
template <typename View> struct PlusEqualFunctor {
  ...
  explicit PlusEqualFunctor(View const view1, View const view2) : mDataV(view1), mOtherV(view2) {}

  KOKKOS_FUNCTION void operator()(int const i) const { mDataV(i) += mOtherV(i); }
};
