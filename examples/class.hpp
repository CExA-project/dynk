...
public:
  ...
  Kokkos::DualView<T *> &data() { return mData; }

  Kokkos::DualView<T *> const &data() const { return mData; }

  int size() const { return mData.d_view.size(); }
  ...
  void show() const {
    ...
    Kokkos::parallel_for(
        "show test array", Kokkos::RangePolicy<Kokkos::Serial>(0, size()),
